...
export const reducers = combineReducers({
  ...
  productos: require('../../modules/entities/producto/producto.reducer').reducer,
  productoCategorias: require('../../modules/entities/producto-categoria/producto-categoria.reducer').reducer,
  clientes: require('../../modules/entities/cliente/cliente.reducer').reducer,
  carritos: require('../../modules/entities/carrito/carrito.reducer').reducer,
  productoOrdens: require('../../modules/entities/producto-orden/producto-orden.reducer').reducer,
